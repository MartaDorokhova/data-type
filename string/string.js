...
// let myInfoText = 'Всем привет! Меня зовут Марта. Сейчас я изучаю язык программирования JavaScript на курсе по JavaScript у Владилен Минин. Я хочу стать веб-разработчиком, потому что хочу сменить раоту. До этого я изучала JavaScript 0,5 месяца. Я уверена, что пройду данный курс до конца!';
